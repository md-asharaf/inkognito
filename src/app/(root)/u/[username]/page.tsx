    ...
    <div className="flex-grow bg-background/50 pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {!isUserAcceptingMessages ? (
          ...
          <div className="bg-card/50 backdrop-blur border border-border/50 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden">
            {/* Decorative background glow */}
            <div className="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 bg-primary/20 blur-3xl rounded-full pointer-events-none" />

            <Form {...form}>
              <form onSubmit={form.handleSubmit((data) => handleSubmit(data))} className="space-y-6 relative z-10">
                <FormField
